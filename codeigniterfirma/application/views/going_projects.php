                        ...
                        <div class="portfolio-item cat1 cat3">
                            <div class="portfolio-item-content">
                                ...
                                <div class="portfolio-description">
                                    <h4>
                                        <a href="going_projects/detail/<?php echo $going_project->ID; ?>"><?php echo $going_project->Name; ?></a>
                                    </h4>

                                    <!-- Change the dummy image -->
                                    <a href="admin/uploads/going_projects/<?php echo $going_project->Image; ?>"
                                       class="portfolio-gallery-set"><i
                                                class="fa fa-search-plus"></i></a><a
                                            href="going_projects/detail/<?php echo $going_project->ID; ?>"><i
