        ...
        <div class="portfolio-content">
            ...
            <div class="portfolio-filter-wrap text-center">
                <ul class="portfolio-filter hover-style-one">
                    <li class=""><a href="#" data-filter="*" class="current"> Tümü</a></li>
                    <?php foreach ($projectscategories as $projectscategory) { ?>
                        <li class="active"><a href="#" data-filter=".cat<?php echo $projectscategory->ID; ?>" class="current"><?php echo $projectscategory->Name; ?></a></li>
                    <?php } ?>
                </ul>
            </div>
            <div class="portfolio portfolio-gutter portfolio-style-2 portfolio-container portfolio-masonry portfolio-column-count-4 "
                 style="position: relative; height: 794.625px;">

                <!-- Single portfolio item -->
                <?php foreach ($projects as $project) { ?>
                    <div class="portfolio-item cat<?php echo $project->ProjectsCategoriesID; ?>" style="position: absolute; left: 0px; top: 0px;">
                        <div class="portfolio-item-content">
                            <div class="item-thumbnail">
                                <!-- Change the dummy image -->
                                <img src="admin/uploads/projects/<?php echo $project->Image; ?>">
                            </div>
                            <div class="portfolio-description">
                                <h4><a href="projects/detail/<?php echo $project->ID; ?>"><?php echo $project->Name; ?></a></h4>

                                <!-- Change the dummy image -->
                                <a href="admin/uploads/going_projects/<?php echo $project->Image; ?>" class="portfolio-gallery-set"><i
                                        class="fa fa-search-plus"></i></a><a target="_blank" href="projects/detail/<?php echo $project->ID; ?>"><i
                                        class="fa fa-link"></i></a>
                            </div>
                        </div>
                    </div>
