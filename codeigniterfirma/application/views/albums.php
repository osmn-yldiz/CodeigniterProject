                            ...
                            <div class="portfolio-item-content">
                                <div class="item-thumbnail">
                                    ...
                                    <img width="363" height="245"
                                         src="admin/uploads/albums/<?php echo $album->Image; ?>"
                                         alt="<?php echo $album->Name; ?>">
                                </div>
                                <div class="portfolio-description">
                                    <h4>
                                        <a href="albums/detail/<?php echo $album->ID; ?>"><?php echo $album->Name; ?></a>
                                    </h4>

                                    <!-- Change the dummy image -->
                                    <a href="admin/uploads/albums/<?php echo $album->Image; ?>"
                                       class="portfolio-gallery-set"><i
                                                class="fa fa-search-plus"></i></a><a
                                            href="albums/detail/<?php echo $album->ID; ?>"><i
