                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    <h4 class="card-title">Ekip Listesi</h4>
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header no-bd">
                                                <h5 class="modal-title">
                                                    <span class="fw-mediumbold">Yeni Ekip Arkadaşı
                                                        Ekle</span>
                                                </h5>
                                            ...
                                            <div class="modal-body">
                                                <p class="small">Bu formu kullanarak yeni
                                                    bir ekip arkadaşı ekleyin, hepsini
                                                    doldurduğunuzdan emin olun.</p>
                                                <form action="teams/insert" method="POST"
                                ...
                                <div class="table-responsive">
                                    <table id="add-row" class="display table table-striped table-hover text-center">
                                        ...
                                        <tbody id="sortable"
                                            data-url="<?php echo base_url("teams/ranksetter"); ?>">
                                            ...
                                            <tr id="rank-<?php echo $team->ID; ?>">
                                                ...
                                                <td><img class="rounded" width="100"
                                                        src="uploads/teams/<?php echo $team->Image; ?>" alt=""></td>
                                                <td><?php echo $team->Name; ?></td>
                                                <td><?php echo $team->Degree; ?></td>
                                                <td>
                                                    <label class="switch">
                                                        <input id="isActive" type="checkbox"
                                                            data-url="<?php echo base_url("teams/isactivesetter/$team->ID"); ?>"
                                                            <?php echo ($team->Status == 1) ? "checked" : ""; ?>>
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        ...
                                                        <a href="teams/delete/<?php echo $team->ID; ?>"
                                            ...
                                            <div class="modal fade" id="updateRowModal<?php echo $team->ID; ?>"
                                                ...
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header no-bd">
                                                            <h5 class="modal-title">
                                                                <span class="fw-mediumbold">Ekip Arkadaşı Güncelleme</span>
                                                            </h5>
                                                            <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group form-group-default">
                                                                            ...
                                                                            <img class="rounded" width="100%" src="uploads/teams/<?php echo $team->Image; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group form-group-default">
                                            ...
                                            <tr>
                                                <td colspan="7">Herhangi bir ekip arkadaşı eklenmemiştir.</td>
                                            </tr>
