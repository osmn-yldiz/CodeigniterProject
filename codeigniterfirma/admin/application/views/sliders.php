                                        ...
                                        <tbody id="sortable"
                                            ...
                                            <tr id="rank-<?php echo $slider->ID; ?>">
                                                ...
                                                <td><img class="rounded" width="100"
                                                        src="uploads/sliders/<?php echo $slider->Image; ?>" alt=""></td>
                                                <td>
                                                    <label class="switch">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group form-group-default">
                                                                            ...
                                                                            <img class="rounded" width="100%" src="uploads/sliders/<?php echo $slider->Image; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-12">
                                                                        <div class="form-group form-group-default">
                                            ...
                                            <tr>
                                                <td colspan="7">Herhangi bir slayt eklenmemiştir.</td>
                                            </tr>
