                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col col-stats ml-3 ml-sm-0">
                                        <div class="numbers">
                                            ...
                                            <h4 class="card-title"><?php echo $this->dm->count("projects", array()); ?>
                                                Adet</h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col col-stats ml-3 ml-sm-0">
                                        <div class="numbers">
                                            ...
                                            <h4 class="card-title"><?php echo $this->dm->count("brands", array()); ?>
                                                Adet</h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col col-stats ml-3 ml-sm-0">
                                        <div class="numbers">
                                            ...
                                            <h4 class="card-title"><?php echo $this->dm->count("services", array()); ?>
                                                Adet</h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col col-stats ml-3 ml-sm-0">
                                        <div class="numbers">
                                            ...
                                            <h4 class="card-title"><?php echo $this->dm->count("faq", array()); ?>
                                                Adet</h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col col-stats ml-3 ml-sm-0">
                                        <div class="numbers">
                                            ...
                                            <h4 class="card-title"><?php echo $this->dm->count("videos", array()); ?>
                                                Adet</h4>
                                        </div>
                                    </div>
                                </div>
